...
public class AdminController {
    ...
    public ServerResponse applyEvent(@ApiParam(name = "applyEventInfo",value = "申请活动的表单实体")
    ...
    public ServerResponse publishNotice(@ApiParam(name = "notice",value = "通知实体") @RequestBody Notice notice){
    ...
    public ServerResponse getAppliedEvents(@ApiParam(name = "applicantId",value = "活动申请者id，也就是对应社团负责人")
                                                       Integer applicantId){
    ...
    public ServerResponse getAllApplyParticipantsByEventId(@ApiParam(name = "eventId",value = "活动id") Integer eventId){
    ...
    public ServerResponse getParticipantsOfPermitByEventId(@ApiParam(name = "eventId",value = "活动id")Integer eventId){
    ...
    public ServerResponse checkParticipateEventTo1(@ApiParam(name = "id",value = "申请参加活动记录的id")Integer id,
                                                   @ApiParam(name = "eventId",value = "活动id")Integer eventId,
                                                   @ApiParam(name = "participantId",value = "报名参加者id")Integer participantId){
    ...
    public ServerResponse checkParticipateEventTo2(@ApiParam(name = "id",value = "申请参加活动记录的id")Integer id,
                                                   @ApiParam(name = "eventId",value = "活动id")Integer eventId,
                                                   @ApiParam(name = "participantId",value = "报名参加者id")Integer participantId){
    ...
    public void printSignInExcelByEventId(@ApiParam(name = "eventId",value = "已通过审核的活动的id") Integer eventId,
    ...
    public ServerResponse modifyAssociation(@ApiParam(name = "association",value = "社团json实体")
    ...
    public ServerResponse getApplyJoinAssocList(@ApiParam(name = "associationId",value = "社团id")
                                                            Integer associationId){
    ...
    public ServerResponse removeOneMemberById(@ApiParam(name = "memberId",value = "成员id，也就是用户id") Integer memberId,
                                              @ApiParam(name ="associationId",value ="成员所在社团的id" ) Integer associationId){
    ...
    public ServerResponse checkApplyJoinTo1(@ApiParam(name = "applyJoinAssocId",value = "申请加入社团表的记录id") Integer applyJoinAssocId,
                                            @ApiParam(name = "applicantId",value = "申请者id（用户id）") Integer applicantId,
                                            @ApiParam(name = "associationId",value = "社团id") Integer associationId){
    ...
    public ServerResponse checkApplyJoinTo2(@ApiParam(name = "applyJoinAssocId",value = "申请加入社团表的记录id") Integer applyJoinAssocId,
                                            @ApiParam(name = "applicantId",value = "申请者id（用户id）") Integer applicantId,
                                            @ApiParam(name = "associationId",value = "社团id") Integer associationId){
